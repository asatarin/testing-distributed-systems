...
* [An Empirical Study on Crash Recovery Bugs in Large-Scale Distributed Systems](http://www.tcse.cn/~gaoyu15/paper/2018-fse-creb.pdf) — based on bug database from "What Bugs Live in the Cloud?" paper reseachers focus specifically on crash recovery bugs in Hadoop MapReduce, HBase, Cassandra, ZooKeeper. There is review of this paper by [Murat Demirbas](https://twitter.com/muratdemirbas) in [his blog].
