...
* [Concurrency Debugging with Differential Schedule Projections](https://brandonlucia.com/pubs/symbiosis_final_pldi.pdf) — find and minimize concurrency bugs using program analysis. Share memory systems are equivalent to message passing systems, so you can apply these same techniques to distributed systems.
