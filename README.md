...
and Flume)
* [TaxDC: A Taxonomy of Non-Deterministic Concurrency Bugs in Datacenter Distributed Systems](https://dl.acm.org/doi/abs/10.1145/2872362.2872374) — comprehensive taxonomy of bugs in distributed systems (Cassandra, Hadoop MapReduce, HBase, ZooKeeper)
...
* [Formal Verification of a Distributed Dynamic Reconfiguration Protocol](https://youtu.be/VwCBlmS7XEA) — talk on formally verifying MongoDB Raft-based replication reconfiguration protocol with TLAPS. Paper [preprint](https://arxiv.org/abs/2109.11987).
